...
using Dessentials.Helpers;
using Dessentials.Serializables;
using UnityEditor;
using UnityEngine.Serialization;
using Object = UnityEngine.Object;

namespace Dessentials.Features.QuickAccess
{
    /// <summary>
    ...
    /// </summary>
    [FilePath("ProjectSettings/Dessentials_QuickAccessConfig.asset", FilePathAttribute.Location.ProjectFolder)]
    public class QuickAccessConfig : ScriptableSingleton<QuickAccessConfig>
    {
        ...
        public void RemovePinnedFromGroup(int groupIndex, Object target)
        {
            ...
            string targetGuid = DAssetHelper.GetGUID(target);
        ...
        private static bool RemoveAllByGuid(List<Object> list, string targetGuid)
        {
            ...
            {
                if (DAssetHelper.GetGUID(list[i]).Equals(targetGuid))
                {
                    list.RemoveAt(i);
                    removed = true;
                }
