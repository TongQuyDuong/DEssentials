...
/// <summary>
        ...
        public class AutoFillDrawer : PropertyDrawer
        {
            ...
            /// </summary>
            private void HandleObjectReferenceProperty(Rect position, SerializedProperty property, GUIContent label,
                AutoFillAttribute autoFill)
            {
            ...
            /// </summary>
            private void HandleArrayProperty(Rect position, SerializedProperty property, GUIContent label,
                AutoFillAttribute autoFill)
            {
                ...
                if (typeof(Component).IsAssignableFrom(elementType))
                {
                    ...
                    {
                        var components =
                            targetMonoBehaviour.GetComponentsInChildren(elementType, true); // Include inactive
            ...
            /// </summary>
            private void FindComponentInChildren(AutoFillAttribute autoFill, SerializedProperty property,
                System.Type fieldType, MonoBehaviour targetMonoBehaviour)
            {
            ...
            /// </summary>
            private void FindScriptableObject(AutoFillAttribute autoFill, SerializedProperty property,
